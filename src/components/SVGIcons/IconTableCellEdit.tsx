...
const IconTableCellEdit = ({
  ...
  >
    <g id="Size=24, Theme=Regular">
      <g id="Shape">
        <path d="M3 8.75C3 7.50736 4.00736 6.5 5.25 6.5H18.75C19.7311 6.5 20.5656 7.12796 20.8733 8.00388C20.8206 8.00132 20.7679 8.00002 20.7151 8H20.713C20.2473 8.00021 19.7806 8.09923 19.3477 8.29694C19.2108 8.11651 18.994 8 18.75 8H15.5L15.5 11.8531L14 13.3531L14 8H10L10 14H13.3531L12.4883 14.8648C12.2951 15.058 12.1249 15.2712 11.9801 15.5H5.25C4.00736 15.5 3 14.4926 3 13.25V8.75ZM5.25 8C4.83579 8 4.5 8.33579 4.5 8.75V13.25C4.5 13.6642 4.83579 14 5.25 14H8.5L8.5 8H5.25Z" />
