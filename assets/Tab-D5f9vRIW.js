import{j as a}from"./jsx-runtime-4NWiPWPm.js";import{B as b}from"./Badge-BXssCP08.js";import{n as v}from"./helpers-no7yRckL.js";import{c as d}from"./index-BKlDniVL.js";const p=m=>{const{size:t="large",iconProps:r,badgeProps:s,label:o,className:i="",disabled:l=!1,isSelected:e,rightIconProps:n,val:c,onClick:g,dataTestId:u}=m;return a.jsxs("div",{"data-test-id":u,onClick:l?v:g,className:d("tab",{[`tab--${t}`]:t},{"tab--disabled":l},{"tab--selected":e},i),children:[r!=null&&r.Component?a.jsx(r.Component,{className:"tab__icon mr-8",size:`${t=="small"?"xsmall":"small"}`,...r}):null,a.jsx("span",{className:"tab__label","data-test-id":u?`${u}-label`:"",children:o}),n!=null&&n.Component?a.jsx(n.Component,{onClick:y=>{n!=null&&n.action&&(y.stopPropagation(),n==null||n.action(c))},className:"tab__icon ml-8",size:`${t=="small"?"xsmall":"small"}`,...n}):null,s!=null&&s.text?a.jsx(b,{className:"tab__badge ml-8",size:"small",type:"secondary",...s}):null]})};p.__docgenInfo={description:"",methods:[],displayName:"TabItem",props:{dataTestId:{required:!1,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"union",raw:"string | React.ReactElement",elements:[{name:"string"},{name:"ReactReactElement",raw:"React.ReactElement"}]},description:""},size:{required:!1,tsType:{name:"union",raw:"'large' | 'medium' | 'small'",elements:[{name:"literal",value:"'large'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'small'"}]},description:""},className:{required:!1,tsType:{name:"string"},description:""},iconProps:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  name?: string
  alignment?: string
