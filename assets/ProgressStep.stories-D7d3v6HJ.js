import{j as t}from"./Text-CKGaIGJ0.js";import{r as i}from"./iframe-DpMxAmj9.js";import"./DropzoneFileUpload-C2ZWgrjN.js";import{p as m,q as s}from"./UnderConstruction-DPyuyZui.js";import{B as n}from"./types-BrDM8sXB.js";import"./ButtonGroup-BgsQd8GB.js";import"./Chips-BmNorCMb.js";import"./preload-helper-Dp1pzeXC.js";import"./IconInfo-BD2IbNse.js";import"./IconChevronDoubleRight-Ij4DwE2P.js";import"./IconDismissCircleFilled-lD4REoq8.js";import"./index-BuZNQKp7.js";const T=[{value:1,label:"label1 label1 label1 label1",subText:"Subtext1",status:s.initial},{value:2,label:"label2",subText:"Subtext2",status:s.initial},{value:3,label:"label3",subText:"Subtext3",status:s.initial}],N={title:"ProgressStep",component:m,argTypes:{stepType:{options:["number","dot"],control:{type:"radio"}},stepDirection:{options:["horizontal","vertical"],control:{type:"radio"}},stepSize:{options:["large","small"],control:{type:"radio"}}}},g=u=>{const[a,d]=i.useState(1),[o,b]=i.useState(T),p=v=>{d(v);const x=o.map(r=>r.value===a?{...r,status:s.completed}:r);b(x)};return t.jsxs("div",{style:{width:500},children:[t.jsx(m,{...u,steps:o,activeStep:a,setActiveStep:p}),t.jsxs("div",{className:"mt-40",children:[t.jsx(n,{buttonText:"back",type:"secondary",className:"mr-8"}),t.jsx(n,{buttonText:"next",type:"primary",onClick:()=>p(2)})]})]})},e=g.bind({});e.args={stepType:"number",stepDirection:"horizontal",stepSize:"large"};var l,c,S;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:`args => {
