import{j as e}from"./jsx-runtime-DfZy_Tt8.js";import{R as $,r}from"./iframe-NHmQ9h-T.js";import{B as l}from"./Button-CUJuh0d-.js";import{b as z,c as V,M as F}from"./Popover-BD_-wZsc.js";import{c as G}from"./index-Cri0wNZf.js";import"./types-Cg5ZwiOm.js";import{T as H}from"./Text-09mmeRSS.js";import"./Tooltip-Do0OpD0Y.js";import{F as U}from"./FormContainer-CY5OfXF5.js";import{M as W}from"./index-7GoKh3Dw.js";import{A as Y,m as A}from"./AnimatePresenceWrapper-DmfRoqPq.js";import{u as J}from"./useDispatchEventOnScroll-xYip-gWD.js";import{C as K}from"./Checkbox-JqjbtDXw.js";import{I as Q,b as X}from"./IconCaretUp-CpxV0ZGj.js";import{I as B}from"./IconDismissFilled-BUIKoiaN.js";import{b as Z,a as _}from"./index.esm-C56WAze0.js";import{c as ee}from"./IconArrowDownloadFilled-BLRE50so.js";import{I as ie}from"./IconMore-B530ascU.js";import{I as se}from"./IconPerson-DduH4ajj.js";import{I as te}from"./IconInfo-CAMwWbOi.js";import"./preload-helper-Dp1pzeXC.js";import"./index-AboGxAif.js";import"./IconDismiss-BgNk2rO4.js";import"./helpers-Com4CbOu.js";import"./Link-BxnZ_4v3.js";import"./index-fA273qB9.js";import"./NestedMenu-DB3novcl.js";import"./CollapseGroup-Debc1M3t.js";import"./Divider-D63fJm-R.js";import"./IconChevronDown-BqfVWeLR.js";import"./IconChevronUp-BJ1AgBHg.js";import"./IconChevronRight-D0KgF9oy.js";import"./AvatarGroup-BHm3zGDx.js";import"./DropzoneFileUpload-al3ZsZmp.js";import"./Label-CBD2QhQt.js";import"./useFormProps-gtoW1Yqg.js";import"./ErrorMessage-57yNdNSd.js";import"./IconDynamicComponent-lk5nW0hk.js";import"./Snackbar-KwavAp9Y.js";import"./Alert-CwVGqmQ8.js";import"./Progress-BHAP65zV.js";import"./IconAdd-CHTgNXel.js";import"./IconCheckmark-BsgsBWxv.js";import"./Empty-BoULT_ae.js";import"./Image-vkhcv00N.js";import"./Input-CFfXKAKU.js";import"./IconCheckmarkCircleFilled-CdfgGNTr.js";import"./IconChevronLeft-BjGhMaIv.js";import"./IconCaretDownFilled-D3EneOVs.js";import"./extends-CF3RwP-h.js";import"./Tab-i4VN6OTK.js";import"./Badge-DVvSLG3q.js";const R=({isLoading:p,footerButtons:m,onClose:u,onSubmit:o,checkboxInfo:a,dataId:n=""})=>{const[c,d]=$.useState((a==null?void 0:a.isChecked)||!1),y=r.useCallback(()=>{o==null||o(c)},[o,c]);if(!m)return null;const{extraButton:b,confirm:t,cancel:f}=m;return e.jsxs("div",{className:"side-sheet__footer","data-id":n?`${n}-footer`:"",children:[a?e.jsx("div",{className:"side-sheet__footer_checkbox",children:e.jsx(K,{label:a.label,selectedValue:c,onClick:d,dataId:n?`${n}-checkbox`:""})}):null,e.jsxs("div",{className:"side-sheet__footer_buttons",children:[b?e.jsx(l,{size:"large",type:"secondary",...m.extraButton,className:"mr-12",dataId:n?`${n}-extra`:""}):null,e.jsx(l,{type:"secondary",size:"large",className:"mr-12",onClick:u,...f,dataId:n?`${n}-cancel`:""}),e.jsx(l,{type:"primary",size:"large",onClick:y,disabled:p,...t,dataId:n?`${n}-confirm`:""})]})]})};R.__docgenInfo={description:"",methods:[],displayName:"Footer",props:{isLoading:{required:!1,tsType:{name:"boolean"},description:""},footerButtons:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  label: string
  isChecked: boolean
}`,signature:{properties:[{key:"label",value:{name:"string",required:!0}},{key:"isChecked",value:{name:"boolean",required:!0}}]}},description:""},dataId:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}}}};const I=p=>{const{size:m="small",isLoading:u,isOpen:o,onClose:a,onSubmit:n,title:c,position:d="right",shouldRemoveCallback:y,className:b="",headerButtons:t,footerButtons:f,scrollToTopOptions:v,children:T,closeOnOutsideClick:q=!0,checkboxInfo:k,dataId:i=""}=p,[x,C]=r.useState(null),[P,s]=r.useState(!1),S=r.useRef(null);z(x,a,o&&q,r.useId(),y),V(o);const E=J();r.useEffect(()=>{var g;if(o&&v){const w=D=>{E(),o&&s(D.currentTarget.scrollTop>v.onPixel)};(g=S.current)==null||g.addEventListener("scroll",w)}o||O()},[o,v]);const O=r.useCallback(()=>{var g;s(!1),(g=S.current)==null||g.scrollTo({top:0,behavior:"smooth"})},[]),j=d==="left";return e.jsx(Y,{children:o?e.jsx(A.div,{className:"side-sheet","data-id":i,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:.1,delay:.3}},transition:{duration:.2},children:e.jsxs(A.div,{initial:j?{left:"-100%"}:{right:"-100%"},animate:j?{left:0}:{right:0},exit:{...j?{left:"-100%"}:{right:"-100%"},transition:{duration:.5}},transition:{duration:.5},className:G("side-sheet__container",`side-sheet__${d}`,`side-sheet__container--${m}`,b),"data-id":i?`${i}-container`:"",ref:C,children:[e.jsxs("div",{className:"side-sheet__header",children:[e.jsxs("div",{className:"side-sheet__header__left pr-16",children:[t!=null&&t.back?e.jsx(l,{size:"small",type:"tertiary",...t.back,className:"mr-8",dataId:i?`${i}-back`:""}):null,e.jsx(H,{className:"side-sheet__title",weight:"bolder",lineHeight:"large",size:"medium",dataId:i?`${i}-title`:"",children:c})]}),e.jsxs("div",{className:"side-sheet__header__right",children:[t!=null&&t.pin?e.jsx(l,{size:"small",type:"tertiary",...t.pin,className:"mr-8",dataId:i?`${i}-pin`:""}):null,t!=null&&t.close?e.jsx(l,{size:"small",type:"tertiary",...t.close,onClick:a,dataId:i?`${i}-close`:""}):e.jsx(l,{size:"small",type:"tertiary",iconProps:{Component:B},onClick:a,dataId:i?`${i}-close`:""})]}),P&&e.jsx(l,{size:"large",type:"secondary",iconProps:{Component:Q},className:`side-sheet__header__scroll-top side-sheet__header__scroll-top__${m}`,dataId:i?`${i}-scroll-top`:"",onClick:O})]}),e.jsx("div",{className:"side-sheet__content scrollbar scrollbar--vertical","data-id":i?`${i}-content`:"",ref:S,children:T}),e.jsx(R,{footerButtons:f,isLoading:u,onClose:a,onSubmit:n,checkboxInfo:k,dataId:i})]})}):null})};I.__docgenInfo={description:"",methods:[],displayName:"SideSheet",props:{closeOnOutsideClick:{required:!1,tsType:{name:"boolean"},description:""},shouldRemoveCallback:{required:!1,tsType:{name:"boolean"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'large' | 'mobile'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'large'"},{name:"literal",value:"'mobile'"}]},description:""},isLoading:{required:!1,tsType:{name:"boolean"},description:""},isOpen:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"(e?: TClickEventType | MouseEvent) => void",signature:{arguments:[{type:{name:"union",raw:"TClickEventType | MouseEvent",elements:[{name:"TClickEventType"},{name:"MouseEvent"}]},name:"e"}],return:{name:"void"}}},description:""},onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(isCheckboxSelected: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"isCheckboxSelected"}],return:{name:"void"}}},description:""},position:{required:!1,tsType:{name:"union",raw:"'right' | 'left'",elements:[{name:"literal",value:"'right'"},{name:"literal",value:"'left'"}]},description:""},title:{required:!1,tsType:{name:"string"},description:""},footerButtons:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  cancel: TButtonPropTypes
  confirm: TButtonPropTypes
  extraButton?: TButtonPropTypes
...
}`,...(N=(M=h.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};const mi=["SideSheet"];export{h as SideSheet,mi as __namedExportsOrder,li as default};
